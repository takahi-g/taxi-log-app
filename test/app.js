...
const APP_UPDATE_INFO = {
    version: "20260723_0430",
    date: "07/23 04:30",
    title: "🎉 アップデートのお知らせ (Ver: 07/23 04:30)",
    details: [
        "🌙 【締め時間機能】日をまたいだ深夜・早朝勤務(夜中2時など)でも日付が自動で翌日にならず、直前の勤務日(前日)として判定される『日付切替時刻』機能を搭載しました！(デフォルト: 朝8:00切り替え。設定画面で変更可能)",
        "📱 【iPhone縦持ち1行＆右揃えデザイン】売上履歴がスマホの縦持ちでも横にはみ出さず、税抜・税込・操作ボタンが一直線にすっきり収まります！",
        "🔍 【金額・文字サイズの拡大】1行表示のまま、金額やラベルの文字・ボタンをはみ出ない限界まで大きくして視認性を高めました！"
    ],
    history: [
        {
            date: "07/17 13:22",
