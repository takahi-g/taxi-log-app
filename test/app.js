...
const APP_UPDATE_INFO = {
    version: "20260709_1853",
    date: "07/09 18:53",
    title: "🎉 アップデートのお知らせ (Ver: 07/09 18:53)",
    details: [
        "📅 曜日や祝日に合わせた個別目標設定に対応しました！(平日、金、土、日、祝、祝前日)",
        "⚡ 平日以外の目標をワンタップでまとめて設定できる「一括コピー」機能を搭載！",
        "📱 各表示テキストを15%拡大し、運転中の視認性を大きく向上させました！",
        "📝 詳細履歴の表示幅と自動改行を防ぐUI調整を行い、スッキリ見やすく改善！",
        "⚠️ 本番とテストの環境を識別できる「テスト表示バナー」を追加しました！"
    ],
    history: [
        {
            date: "07/07 16:43",
